...
export class AddEventComponent implements OnInit {
  ...
  onSubmit() {
    ...
    formValues.isRegistrationAllowed =
      formValues.isRegistrationAllowed === 'yes';
    ...
    this.eventService.addEvent(formValues).subscribe(
      () => {
        ...
        /*
         * Anything you pass to `close()` will be received by whoever is
         * activating the dialog window (in this case, the `Add new event`
         * button in the EventManagement component)
         */
